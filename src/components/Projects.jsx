...
import emailSender from '../assets/emailSender.png';
function Projects() {
  const projectList = [
    {
    ...
    }, 
    {
      ...
      image: emailSender,
      description: 'The Bulk Email Sender is a web-based application designed to streamline the process of sending emails to multiple recipients efficiently and reliably. This tool offers a user-friendly interface for uploading recipient lists, composing messages, and managing email campaigns, making it ideal for marketing teams, educators, and organizations.Uses Nodemailer for sending emails through SMTP servers.Integration with MongoDB to log and track email status, including success, failures, and retries.Frontend: HTML, CSS, JavaScript (optional enhancement: React.js for better UX)Backend: Node.js, Express.js',
      link: "https://email-sender-client-alpha.vercel.app/",
    }, 
    {
